...
// alert('hu');
	...
	$('#lights').click(function () {
	    ...
	    $('.test .kawaii-button-box').append('<a href="#" target="blank"><button class="kawaii-button button-added"> My Profile 👸 </button></a> <a href="#" target="blank"><button class="kawaii-button button-added"> Support Me ⚔️ </button></a>');
...
// document.getElementById('domdomdom').addEventListener('click', function() {
